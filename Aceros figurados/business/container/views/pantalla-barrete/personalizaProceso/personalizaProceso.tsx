...
export default function PersonalizaProceso(props:any) {
    ...
    const analytic = () =>{
        props.gaEventTracker(`Personalizar ahora Pantalla-barrete`);
    }
    return (
        <>
            <section className={styles.section}>
                <div className={styles.general}>
                    ...
                    <div className={styles.boton}>
                        <a onClick={analytic} title="personalize" className={styles.btn_personaliza} href={t("header:nav.item.button.url")} target="_blank">Personalizar ahora</a>
                    </div>
                </div>
            </section>
        </>
