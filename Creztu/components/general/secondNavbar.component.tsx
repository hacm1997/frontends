        ...
        <div className='flex items-center justify-between h-16 pt-10 '>
          ...
          <div className='hidden lg:block'>
            <div className='ml-4 flex items-center space-x-4'>
              <li className='hover:bg-[--color-primary] hover:text-white rounded-lg p-2 list-none text-xl'><Link title='' href="/sitiosweb">Sitios web</Link></li>
              <li className='hover:bg-[--color-primary] hover:text-white rounded-lg p-2 list-none text-xl'><Link title='' href="/mailings">Mailings</Link></li>
              <li className='hover:bg-[--color-primary] hover:text-white rounded-lg p-2 list-none text-xl'><Link title='' href="/ecommerce">Ecommerce</Link></li>
              <li className='hover:bg-[--color-primary] hover:text-white rounded-lg p-2 list-none text-xl'><Link title='' href="/bookingplatform">Booking platform</Link></li>
            </div>
          </div>
          <div className='hidden lg:block'>
            <div className='ml-4 flex items-center space-x-4'> 
      ...
      {isClick && (
        <div className='lg:hidden bg-white'>
          <div className='px-2 pt-5 pb-3 spa-y-1 sm:px-3 '>
            <li className='hover:bg-[--color-primary] hover:text-white rounded-lg p-2 list-none text-xl'><Link title='' href="/sitiosweb">Sitio web</Link></li>
            <li className='hover:bg-[--color-primary] hover:text-white rounded-lg p-2 list-none text-xl'><Link title='' href="/mailings">Mailings</Link></li>
            <li className='hover:bg-[--color-primary] hover:text-white rounded-lg p-2 list-none text-xl'><Link title='' href="/ecommerce">Ecommerce</Link></li>
            <li className='hover:bg-[--color-primary] hover:text-white rounded-lg p-2 list-none text-xl'><Link title='' href="/bookingplatform">Inmobiliaria</Link></li>
          </div>
          <div className=''>
