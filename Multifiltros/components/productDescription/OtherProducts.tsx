...
export const OtherProducts = ({productDetails}: props) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-10'>
      <div className='mx-4'>
        <p className='text-red-custom text-xl not-italic font-medium pb-4 lg:pl-8'>Productos que te podrían gustar </p>
        <p className='text-blue-custom text-3xl lg:text-5xl not-italic font-bold'>
          <span className='text-red-custom'>|</span> Quienes vieron este producto también compraron
        </p>
      </div>
